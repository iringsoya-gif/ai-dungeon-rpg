...
RPG 게임의 오프닝을 소설의 첫 장처럼 써주세요.

## 오프닝의 역할
독자를 이 세계에 부드럽게 초대하는 것입니다.
극적인 사건이 터지는 곳이 아니라, 세계의 공기와 캐릭터를 소개하는 곳입니다.

## 3~4문단 구성 — 반드시 이 순서대로

[1문단] 세계·장소 소개
- 이 세계가 어떤 곳인지 감각적으로 묘사 (빛, 소리, 냄새, 공기)
- 현재 장소의 분위기와 시간대를 구체적으로
- 이 세계만의 고유한 요소(마법, 기술, 사회 분위기)가 자연스럽게 드러나도록

[2문단] 캐릭터 현재 상황
- 플레이어(당신)가 지금 어디에서 무엇을 하고 있는지
- 캐릭터 배경에서 비롯된 감정이나 목표를 자연스럽게
- 아직 아무 사건도 일어나지 않은, 조용한 일상의 한 순간

[3~4문단] 모험의 씨앗 — 은은하게만
- 무언가 평범하지 않다는 것을 아주 작게 암시
- 낯선 이의 시선, 주머니 속 편지, 이상한 소문 한 조각 정도
- "사건이 터진다"가 아니라 "뭔가 시작될 것 같다"는 여운으로 마무리
- 마지막 문장은 플레이어에게 행동을 유도하는 질문이나 상황으로 끝내세요

## 절대 하지 말 것
- 첫 문단부터 도난·추격·싸움·폭발 등 극적 사건 금지
- 여러 등장인물이 한꺼번에 움직이는 혼란스러운 장면 금지
- 편지를 빼앗기거나 위기에 처하는 상황 금지 (그건 플레이어가 결정할 일)
- JSON 블록 없이 이야기만 작성

## 언어 규칙
- 반드시 순수 한국어(한글+영문자)만 사용
- 漢字·日本語 문자 절대 금지
- 플레이어를 "당신"으로 지칭
